...
public class Fitto2 {
	...
	public static void main(String[] args) throws InterruptedException {
       ...
       driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(70));
	    Thread.sleep(10000);
	    WebElement eyecart=driver.findElement(By.xpath("//body/div[1]/div[3]/div[3]/div[1]/div[2]/div[2]/ul[1]/li[7]/i[1]"));//CHANGE
	   eyecart.click();
	   ...
	   WebElement Radio=driver.findElement(By.xpath("//input[@value=\"online\"]"));
	    ...
	    WebElement cart =driver.findElement(By.xpath(" //body/div[1]/div[3]/div[3]/div[1]/div[2]/div[2]/ul[1]/li[9]/i[1]"));//CHANGE
	    cart.click();
		...
		WebElement eyecart1=driver.findElement(By.xpath("//body/div[1]/div[3]/div[3]/div[1]/div[2]/div[2]/ul[1]/li[9]/i[1]"));////i[@class='fa fa-eye fa-custom-appointment-status'] C
		eyecart1.click();
