...
//	    
	    Thread.sleep(10000);
	    WebElement eyecart1=driver.findElement(By.xpath("//body/div[1]/div[3]/div[3]/div[1]/div[2]/div[2]/ul[1]/li[10]/i[1]"));//CHANGE           //body/div[1]/div[3]/div[3]/div[1]/div[2]/div[2]/ul[1]/li[5]/i[1]
	    eyecart1.click();
...
//		 WebElement BeforeAppointmentElement = wait1.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//body/div[1]/div[3]/div[3]/div[1]/div[2]/div[2]/ul[1]/li[10]/a[1]")));
...
//		 WebElement AfterAppointmentElement = driver.findElement(By.xpath("//body/div[1]/div[3]/div[3]/div[1]/div[2]/div[2]/ul[1]/li[10]/a[1]"));
...
//		 {    System.out.println("selected appointment and conformed appointment is same");
//		 } 
//		 else 
//		 {   
//			 System.out.println("selected appointment and conformed appointment is different");
//		 }
		 driver.quit();
	}
